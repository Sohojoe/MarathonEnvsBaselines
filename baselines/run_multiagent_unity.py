...
def train(args, extra_args):
    ...
    alg_kwargs = get_learn_function_defaults(args.alg, 'mujoco')
...
def build_env(args):
    ...
    #                                inter_op_parallelism_threads=1))
       env = make_multi_unity_vec_env(env_id, env_type, args.num_env or 1, seed, reward_scale=args.reward_scale)
